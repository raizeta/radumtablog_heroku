...
class KategoriController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EntitasBundle:Kategori')->findAll();

        return $this->render('EntitasBundle:Kategori:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EntitasBundle:Kategori:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EntitasBundle:Kategori')->find($id);
        ...
        return $this->render('EntitasBundle:Kategori:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EntitasBundle:Kategori:edit.html.twig', array(
            'entity'      => $entity,
